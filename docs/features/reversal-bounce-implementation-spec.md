...
>
> **Đọc trước khi code:**
> 1. `docs/features/reversal-bounce.md` — spec tổng quan (state machine, scoring tổng thể, hard gate, regime rule).
> 2. `docs/features/phase0a-audit-reports/0A.1-0A.4 + 00-summary.md` — audit codebase đã verify.
> 3. File này.
>
> **Quy tắc cứng:**
